...
exports.fetch_single_data = async (req,res) =>{
    ...
    try{
        ...
        const edu_details = await RunQuery(edu_query,id);
        ...
        const exp_details = await RunQuery(exp_query,id);
        ...
        const rows = await RunQuery(lang_query,id);
        let lang_details ={};
        ...
        let techdetails = await RunQuery(tech_query,id);
        let tech_details ={};
        ...
        const refer_details = await RunQuery(refer_query,id);

        const preferances_query = "SELECT * FROM preferances where emp_id = ?";
        const preferances_details = await RunQuery(preferances_query,id);
