...
const registation = require('../services/registation');
...
const fetch_stu_data = require('../services/fetch_stu_data');
const fetch_single_data = require('../services/fetch_single_data');
